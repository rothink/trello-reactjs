...
class Panel extends Component {
	...
	handleRemoveCard(cardId) {
		...
		this.props.removeCard(panelId, cardId)
	}

	handleRemovePanel(panelId) {
		const { cards } = this.props.panel

		this.props.removePanel(panelId)

		cards.forEach(card => this.props.removeCard(panelId, card))
	}
						...
						<div className="panel panel-default">
							<div className="panel-heading">
								<InputEditable 
									...
									removeComponent={ this.handleRemovePanel }
								/>
							</div>
